function historialPeticionPlanificadas() {

    console.log("historialPeticionPlanificadas");

    x = $.ajax({
            url: "Controlador/Historial/historialPeticionPlanificadas/historialPeticionPlanificadas.php",
            type: "POST",
            async: true,
        })
        .done(function (dat, est, obj) {
            ...
            console.log(obj);
            var peticionPla = dat;
            printDatosPeticionPlanificadas(peticionPla);
            activarDataTable('historialPeticionesPlanificadas');

        })
        .fail(function (obj, est) {
            console.log("FAIL");
            $("#historialPeticionesPlanificadas .rows").empty();
            status = est;
            console.log(obj);
            console.log("---------------------------------------------------------");
        });
...
function printDatosPeticionPlanificadas(datosPeticion) {

    tabla = 'historialPeticionesPlanificadas';
