function historiaInspeccionAtendia() {

    console.log("historiaInspeccionAtendia");

    x = $.ajax({
            url: "Controlador/Historial/HistoriaInspeccionAtendida/historiaInspeccionAtendida.php",
            type: "POST",
            async: true,
        })
        .done(function (dat, est, obj) {
            ...
            printDatosInspeccionAtendidas(inspeccionesPla);
            activarDataTable('historialInspeccionesRealizadas');

        })
        .fail(function (obj, est) {
            console.log("FAIL");
            $("#historialInspeccionesRealizadas .rows").empty();
            status = est;
            console.log(obj);
            console.log("---------------------------------------------------------");
        });
...
function printDatosInspeccionAtendidas(datosPeticion) {

    tabla = 'historialInspeccionesRealizadas';
